...
#### ⚡Main Stacks:
[![My Skills](https://skillicons.dev/icons?i=js,react,tailwind,dart,flutter,firebase)](https://skillicons.dev)
#### 🧩 Extras:
[![My Skills](https://skillicons.dev/icons?i=html,css,ts,next,kali,figma)](https://skillicons.dev)
